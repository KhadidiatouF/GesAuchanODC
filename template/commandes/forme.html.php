...
<body class="bg-darker-bg text-white min-h-screen"> -->
    ...
    <nav class="flex items-center justify-between">
      <div class="flex items-center space-x-2">
        <div class="w-8 h-8 bg-green-accent rounded flex items-center justify-center">
          <span class="text-black font-bold text-sm"></div><i class="fa-solid fa-bell"></i></span>
        </div>
      ...
      <div class="flex space-x-8">
        ...
        <div class=""></div><i class="fa-solid fa-bell"></i></div>
      </div>
    </nav>
  </header> 
  ...
  <main class="max-w-6xl mx-auto px-6 py-8">-->
    ...
    <div class="flex justify-between items-center">
      ...
      <a href="/factureCommande">
         <button
            class="bg-green-accent hover:bg-green-hover text-black font-medium px-8 py-3 rounded-lg transition-colors">
            Valider commande
          </button>
      </a>
